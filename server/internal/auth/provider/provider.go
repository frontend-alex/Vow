// Package provider contains OIDC/OAuth2 provider implementations used by the app.
//
...
//     including ID token verification and standardized claims. Examples: Google and Apple.
//
//  2. OAuth2-Only Providers: Providers that only implement OAuth2 without OIDC support,
//     requiring direct calls to their user info endpoints.
//
// # Usage
//
...
import (
	...
	"golang.org/x/oauth2"
	authoidc "vow/server/internal/auth/oidc"
)
...
// response schemas.
//
// This type can be used for future OAuth2-only providers if the app needs them.
...
//   - userInfoURL: The provider's user info endpoint URL
...
//	    }
//	}
//	provider := NewOAuth2Provider("custom", oauth2Config, userInfoURL, extractFunc)
